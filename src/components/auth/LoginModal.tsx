    ...
    >
      <form onSubmit={handleAuth} className="space-y-6">
        ...
        {!isResetMode && (
          <div className="relative">
            <label className="block text-sm font-medium text-[#1d1d1f] mb-2 flex items-center gap-2">
              <Lock size={16} className="text-apple-blue" />
              Contraseña
            </label>
            <div className="relative">
              <input
        ...
        <div className="text-center mt-6 pt-4 border-t border-gray-100">
          <button
            ...
            className="text-sm text-apple-blue hover:text-[#155dd4] focus:outline-none focus:ring-2 focus:ring-apple-blue focus:ring-offset-2 focus:ring-offset-white rounded-lg px-2 py-1 transition-colors font-medium"
          >
            {isResetMode ? (
              <div className="flex items-center gap-2">
                <User size={14} />
